var getTableDataAJAX = function() {
	...
	getTableData.onreadystatechange = function() {
		if(getTableData.readyState === 4) {
			...
			var tableCellsHead   = tableInfo.tableCellsHead;
			...
			var createTable = function() {
				...
				for (i = 1; i < tableCellsHead.length; i++) {
					//create new heading
					...
					petData.textContent = tableCellsHead[i];
				};
				...
				tableRowFirstHead.textContent = tableCellsHead[0]
